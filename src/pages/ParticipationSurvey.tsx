...
| 조민성 | 안랩클라우드메이트             | Hugo와 GitHub Action을 활용한 개인 블로그 개발 및 배포 | 1회, 3시간, 1주 과정 |
| 정규석 | WhaTap Labs                  | 리눅스/애플리케이션 모니터링 방법                  | 주 1회, 2시간, 4주 과정 |
| 정미르 | 안랩                          | 백엔드? 그냥 Django로 시작하면 돼                  | 주 1회, 2시간, 4주 과정 |
| 추영욱 | Arcturus Lab                 | 금융 데이터를 활용한 시계열 데이터 분석            | 주 1회, 2시간, 4주 과정 |
| 추영욱 | Arcturus Lab                 | Apache Airflow를 활용한 데이터 파이프라인 구축     | 주 1회, 2시간, 4주 과정 |
